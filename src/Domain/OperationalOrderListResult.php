<?php
/**
 * A paginated page of operational order summaries.
 *
...
/**
 * Plain data returned by {@see OrderSource::list_summaries()}.
 */
final class OperationalOrderListResult {

	/**
	 * This page's rows.
	 *
	 * @var list<OperationalOrderSummary>
	 */
	private array $items;
	 ...
	 *
	 * @param array<int, OperationalOrderSummary> $items    Page rows.
