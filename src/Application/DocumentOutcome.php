...
final class DocumentOutcome {
	 ...
	 */
	private function __construct( bool $succeeded, ?string $html, ?int $document_id, ?string $failure_code, ?string $failure_message ) {
	 ...
	 */
	public static function succeeded( string $html, int $document_id ): self {
		return new self( true, $html, $document_id, null, null );
	}
