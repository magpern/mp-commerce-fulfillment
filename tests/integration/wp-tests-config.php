...
$mpcf_core_dir = getenv( 'WP_CORE_DIR' );
if ( ! $mpcf_core_dir ) {
	$mpcf_core_dir = dirname( __DIR__ ) . '/tmp/wordpress';
}

define( 'ABSPATH', rtrim( $mpcf_core_dir, '/' ) . '/' );
...
define( 'WP_TESTS_TITLE', 'Commerce Fulfillment Test Site' );
