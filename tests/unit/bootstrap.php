...
require_once __DIR__ . '/Application/Doubles/InMemoryAnalyticsDailyRepository.php';
require_once __DIR__ . '/Application/Doubles/InMemoryAnalyticsEventSource.php';
...
require_once __DIR__ . '/Application/Doubles/InMemoryScanCorrectionStore.php';
require_once __DIR__ . '/Application/Doubles/InMemoryWaveRepository.php';
...
if ( ! function_exists( 'esc_html_e' ) ) {
	function esc_html_e( $text, $domain = 'default' ) { // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedFunctionFound, Generic.CodeAnalysis.UnusedFunctionParameter.FoundAfterLastUsed
