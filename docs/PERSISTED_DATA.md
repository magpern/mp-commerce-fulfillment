...
| `mpcf_wave_members` | 7 | Wave membership — `(wave_id, fulfillment_id)` PK, `position`, `joined_at`, `picked_at`. Index on `fulfillment_id`. Open-wave exclusivity enforced in Application. |
