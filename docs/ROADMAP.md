...
8. **M8 — Wave & batch picking** — **released as `v0.8.0`** (merged, tagged,
   Release workflow green, installable zip published). Wave aggregate +
...
9. **M9 — Operational Analytics & Insights (Analytics I)** — **released as
   `v0.9.0`** (PR #7 merged, tag pushed, Release workflow green, installable
   zip published). Schema migrator **8** (`mpcf_analytics_daily`),
   AnalyticsEngine LIVE/ROLLUP/REBUILD, Analytics admin, read-only REST,
...
10. **M10 — Operational Hardening & Production Readiness** — **released as
    `v0.10.0`** (PR #8 merged, tag pushed, Release workflow green,
...
11. **v1.0 — Architecture Freeze & Production Readiness** — **P1 COMPLETE**
    (Architecture Freeze **ACTIVE**, 2026-08-07). **P2 COMPLETE**. **P3
    COMPLETE** (Operational Certification — see
    `docs/certification/P3_OPERATIONAL_CERTIFICATION_REPORT.md`). **P4 READY
    TO START** — v1.0 Release Candidate Approval & Release; **not started.**
    This is **not M11** and **not** a feature milestone. Remaining phases:
    P4 administrative `v1.0.0` release → P5 production deploy & hypercare
